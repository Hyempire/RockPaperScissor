...
image = cv2.imread("D:\GIT\RockPaperScissor\z_PresentationImage\image8_succeed\heeyon_scissor_43.png")
...
# ==================== 저장할 경로를 설정해주세용 ==================== #
cv2.imwrite("D:/GIT/RockPaperScissor/z_PresentationImage/result.png", resultImage)
cv2.imwrite("D:/GIT/RockPaperScissor/z_PresentationImage/result_mask.png", mask)