"""
실시간 영상에서 C를 누르면 손을 캡쳐하고 저장하는 코드
"""
...
while cap.isOpened():
    ...
    if cv2.waitKey(1) == ord('c'):
        ...
        cv2.imwrite('D:/GIT/RockPaperScissor/z_PresentationImage/captured.png', image)
        cv2.imwrite('D:/GIT/RockPaperScissor/z_PresentationImage/captured_roi.png', roi)
        print("Captured")
        ...
        resultImage, mask = ImageProcessing.DeleteBackground(roi, hand_color, 30,60,300, max_area=300)
        cv2.imwrite('D:/GIT/RockPaperScissor/z_PresentationImage/RealtimeHSV.png', resultImage)
        cv2.imwrite('D:/GIT/RockPaperScissor/z_PresentationImage/Realtimemask.png', mask)
